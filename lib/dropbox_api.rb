...
require 'dropbox_api/errors/copy_reference_get_error'
require 'dropbox_api/errors/copy_reference_save_error'
...
require 'dropbox_api/results/copy_reference_get_result'
require 'dropbox_api/results/copy_reference_save_result'
